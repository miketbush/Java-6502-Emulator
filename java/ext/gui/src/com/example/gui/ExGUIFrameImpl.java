...
public class ExGUIFrameImpl extends JFrame implements EmulatorFrame, BusListener, EmulatorDisplay, KeyListener, MouseWheelListener, ActionListener
{
	private Emulator emulator;
	private JMenuBar menuBar;
	

	public ExGUIFrameImpl()
	{
		this(null,0,0,0,0);
	}
	
	public ExGUIFrameImpl(String emulatorTitle, int initialX, int initialY, int initialWidth, int initialHeight)
	{
	    super();
	...
	protected JMenu createFileMenu(Font menuFont)
	{
		...
		menuExit.addActionListener(new ActionListener() 
		{
			...
			{
				dispatchEvent(new WindowEvent(ExGUIFrameImpl.this, WindowEvent.WINDOW_CLOSING));
			}
		});
		menu.add(menuExit);
		return menu;
	...
	protected ActionListener fileOpenHandler = new ActionListener()
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			int returnVal = fc.showOpenDialog(ExGUIFrameImpl.this);

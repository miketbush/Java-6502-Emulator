...
public class ExInstructionsImpl extends JPanel implements EmulatorDisplay, ActionListener, KeyListener, BusListener, MouseWheelListener
{
	...
	public ExInstructionsImpl(Emulator emulator)
	{
		super(null);

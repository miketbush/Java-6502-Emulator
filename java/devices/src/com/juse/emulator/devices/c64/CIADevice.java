...
public class CIADevice implements BusDevice, RaisesIRQ, HasPorts
{
	...
	public CIADevice(BusAddressRange bar)
	{
		...
		ports[CONST_COL_BUFFER]  	= (BusDevice) new AuxPortImpl("COL_KEY_BUFFER",bar.getLowAddress() 	+ CONST_COL_BUFFER);
		ports[CONST_ROW_BUFFER] 	= (BusDevice) new AuxPortImpl("ROW_KEY_BUFFER",bar.getLowAddress()	+ CONST_ROW_BUFFER);
